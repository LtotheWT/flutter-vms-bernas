...
class WhitelistSavePhotoResponseDto {
  const WhitelistSavePhotoResponseDto({
  ...
  factory WhitelistSavePhotoResponseDto.fromJson(Map<String, dynamic> json) {
    return WhitelistSavePhotoResponseDto(
  ...
  WhitelistSavePhotoResultEntity toEntity() {
