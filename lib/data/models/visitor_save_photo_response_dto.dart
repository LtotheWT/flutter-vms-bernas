...
class VisitorSavePhotoResponseDto {
  const VisitorSavePhotoResponseDto({
  ...
  factory VisitorSavePhotoResponseDto.fromJson(Map<String, dynamic> json) {
    return VisitorSavePhotoResponseDto(
  ...
  VisitorSavePhotoResultEntity toEntity() {
